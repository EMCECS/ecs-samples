...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	...
	return &ReconcileJob{client: mgr.GetClient(), scheme: mgr.GetScheme(), clientset: clientset, recorder: mgr.GetRecorder("ecscluster-operator")}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &ecsv1.Job{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func checkPods(client kubernetes.Interface, cr *ecsv1.Job, recorder record.EventRecorder) (bool, error) {
...
func newDaemonSetForCR(cr *ecsv1.Job) (*appsv1.DaemonSet, error) {
