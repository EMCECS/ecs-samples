...
const (
	DaemonsetSA   = "ecs-daemonset-sa"
	StatefulsetSA = "ecs-statefulset-sa"

	CSIProvisionerClusterRoleName    = "ecs:csi-provisioner"
	CSIProvisionerClusterBindingName = "ecs:csi-provisioner"

	CSIAttacherClusterRoleName    = "ecs:csi-attacher"
	CSIAttacherClusterBindingName = "ecs:csi-attacher"

	CSIDriverRegistrarClusterRoleName       = "ecs:driver-registrar"
	CSIDriverRegistrarClusterBindingName    = "ecs:driver-registrar"
	CSIK8SDriverRegistrarClusterBindingName = "ecs:k8s-driver-registrar"

	KeyManagementRoleName    = "ecs:key-management"
	KeyManagementBindingName = "ecs:key-management"

	FencingClusterRoleName    = "ecs:pod-fencer"
	FencingClusterBindingName = "ecs:pod-fencer"
)
