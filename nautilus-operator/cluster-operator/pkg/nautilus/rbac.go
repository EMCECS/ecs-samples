...
const (
	DaemonsetSA   = "nautilus-daemonset-sa"
	StatefulsetSA = "nautilus-statefulset-sa"

	CSIProvisionerClusterRoleName    = "nautilus:csi-provisioner"
	CSIProvisionerClusterBindingName = "nautilus:csi-provisioner"

	CSIAttacherClusterRoleName    = "nautilus:csi-attacher"
	CSIAttacherClusterBindingName = "nautilus:csi-attacher"

	CSIDriverRegistrarClusterRoleName       = "nautilus:driver-registrar"
	CSIDriverRegistrarClusterBindingName    = "nautilus:driver-registrar"
	CSIK8SDriverRegistrarClusterBindingName = "nautilus:k8s-driver-registrar"

	KeyManagementRoleName    = "nautilus:key-management"
	KeyManagementBindingName = "nautilus:key-management"

	FencingClusterRoleName    = "nautilus:pod-fencer"
	FencingClusterBindingName = "nautilus:pod-fencer"
)
