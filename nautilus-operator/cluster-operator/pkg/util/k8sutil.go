...
func WaitForClusterToTerminate(kubeClient client.Client, p *v1alpha1.NautilusCluster) (err error) {
	listOptions := &client.ListOptions{
		LabelSelector: labels.SelectorFromSet(LabelsForNautilusCluster(p)),
	}
