...
// ClusterStatus defines the observed state of NautilusCluster
type ClusterStatus struct {
	...
	// Members is the Nautilus members in the cluster
...
// ClusterCondition shows the current condition of a Nautilus cluster.
// Comply with k8s API conventions
type ClusterCondition struct {
	// Type of Nautilus cluster condition.
