...
public class _12_ObjectAcl {
    ...
    public static void main(String[] args) throws Exception {
        ...
        setObjectAcl( AWSS3Factory.getS3ClientWithV4Signatures(), AWSS3Factory.S3_BUCKET_2, AWSS3Factory.S3_OBJECT, acl, invalidAcl );
    }
     ...
     * @param invalidAcl
     */
    private static void setObjectAcl(AmazonS3 s3Client, String bucketName, String key, AccessControlList acl, AccessControlList invalidAcl ) {
        try {
     ...
     * @param invalidAcl
     */
    private static void setAndCheckInvalidObjectAcl(AmazonS3 s3Client, String bucketName, String key, AccessControlList invalidAcl) {
        try {
     ...
     * @param key 
     */
    private static void checkObjectAcl(AmazonS3 s3Client, String bucketName, String key) {
        try {
            AccessControlList result = s3Client.getObjectAcl(bucketName, key);
            System.out.println("object acl for " + bucketName + "/" + key + ":");
